...
if __name__=='__main__':
    ...
    for l in lines:
        ...
        #if len(l.split(" ")[1][:-1]) < 3:
        jdlName = fdescrip+"_"+fidx+"_resubFromList.jdl"
        jdl = open(jdlName,"w")
